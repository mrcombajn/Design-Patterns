namespace DesignPatterns.Patterns.Builder
{
    public class ComputerImpl : AbstractComputer
    {
        ...
        public ComputerImpl(string _processor, string _motherboard, string _psu, string _graphic_card, string _keyboard, string _mouse, int _ram_size)
        {
            this._processor = _processor;
            this._motherboard = _motherboard;
            this._psu = _psu;
        ...
        public ComputerImpl(string _processor, string _motherboard, string _psu, string _graphic_card, int _ram_size, int _number_of_fans, bool _cd_rom)
        {
            this._processor = _processor;
            this._motherboard = _motherboard;
            this._psu = _psu;
        ...
        public ComputerImpl(string _processor, string _psu, string _graphic_card, string _mouse)
        {
            this._processor = _processor;
            this._psu = _psu;
            this._graphic_card = _graphic_card;
